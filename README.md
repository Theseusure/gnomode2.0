...
1. Вкладка **Автопарс** → **Проверить Telegram** (должен прийти пинг).
2. Задайте фильтры (см. профиль ниже) → **Вкл** или «Запустить сейчас».
3. Смотрите лог: скринер → hold/qualify → парсинг → Telegram.
